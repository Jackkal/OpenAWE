...
MeshManager::MeshManager() {
	...
	else if (ResMan.hasResource("objects/hardcoded/helpers_missingmesh.binfbx"))
		_missingMeshPath = "objects/hardcoded/helpers_missingmesh.binfbx";
	...
	else if (ResMan.hasResource("objects/hardcoded/helpers_brokenmesh.binfbx"))
		_brokenMeshPath = "objects/hardcoded/helpers_brokenmesh.binfbx";
